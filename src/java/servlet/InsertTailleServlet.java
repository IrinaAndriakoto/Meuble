...
@WebServlet("/insertTaille")
public class InsertTailleServlet extends HttpServlet {
    
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException {
            request.getRequestDispatcher("WEB-INF/insertTaille.jsp").forward(request, response);
        }
    
    
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String tailleValue = request.getParameter("taille");
        ...
        try {
            ...
            dataService.insertTaille(connection, tailleValue);
            ...
            request.setAttribute("errorMessage", "Une erreur s'est produite lors de l'insertion de la taille : " + e.getMessage());
